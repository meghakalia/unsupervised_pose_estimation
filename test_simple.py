...
def test_simple(args):
    ...
    folder_names = glob.glob(os.path.join(args.output_dir, '**/SelfSupervised-NoArtifactRemoval-PoseLoss-LongtermLoss/PoseOnly/*'))
    ...
    for file in prefixed:
        ...
        output_directory = output_names[file_phantom][file_seq]
